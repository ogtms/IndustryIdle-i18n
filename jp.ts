export const JP = {
    ...
    PlayerTradeQuotaDescV2:
        "💡取引枠とは、現在の単価で取引できる資源量のことです。あなたの都市の市場価格と単価の差が大きいほど、取引枠は減ります。割当量は、あなたの会社の時価総額の%{percent}で、マーケットが更新されるとリセットされます",
    ...
    RequireExpansionPack2Desc: "この機能は拡張パック2でのみ利用可能です",
    Reindeer: "Reindeer",
